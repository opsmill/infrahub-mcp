...
See the [Installation guide](../guides/installation.mdx#add-to-your-mcp-client) for the minimal VS Code config snippet. This page covers VS Code-specific details and the Copilot compatibility flag.
