...
See the [Installation guide](../guides/installation.mdx#add-to-your-mcp-client) for the minimal Claude Code config snippet. This page covers Claude Code-specific workflows.
