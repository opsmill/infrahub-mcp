...
See the [Installation guide](../guides/installation.mdx#add-to-your-mcp-client) for the minimal Cursor config snippet. This page covers Cursor-specific UX tuning beyond the basics.
