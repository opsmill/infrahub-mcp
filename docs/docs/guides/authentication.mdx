...
This guide walks through configuring each authentication mode. For an explanation of how the auth architecture works and when to choose each mode, see [Authentication architecture](../topics/authentication.mdx).
