...
:::info
You can use multiple clients to interact with the Infrahub MCP server, depending on your workflow and language preferences.
:::
...
Then open the MCP Servers Config file (Cmd+Shift+P and type "MCP: Open User Configuration") and replace the default env values with your own.
